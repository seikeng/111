...
SUPERUSER = str(os.getenv("AUTOPCR_SERVER_SUPERUSER", "280913121"))
...
PUBLIC_ADDRESS = os.getenv("AUTOPCR_PUBLIC_ADDRESS", "seikeng.familyds.com:250")
USE_HTTPS = strtobool(os.getenv("AUTOPCR_USE_HTTPS", "true"))
